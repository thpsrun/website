...
class RoleAPIKey(AbstractAPIKey):
    """
    Custom API Key model with role-based permissions.
    
    Extends AbstractAPIKey to include role field for fine-grained access control.
    Replaces the name-based role system with a proper database field.
    """
